...
#include <v10_cat2_detector/Cat2DetectorParamsConfig.h>
...
private:
    ...
    v10_cat2_detector::Cat2DetectorParamsConfig config_;
    dynamic_reconfigure::Server<v10_cat2_detector::Cat2DetectorParamsConfig> param_server_;
    dynamic_reconfigure::Server<v10_cat2_detector::Cat2DetectorParamsConfig>::CallbackType param_cb_;
    void paramCallback(v10_cat2_detector::Cat2DetectorParamsConfig &_config, uint32_t level);
