...
#include <v9_ball_pillar_detector/BallDetectorParamsConfig.h>
...
private:
    ...
    v9_ball_pillar_detector::BallDetectorParamsConfig config_;
    dynamic_reconfigure::Server<v9_ball_pillar_detector::BallDetectorParamsConfig> param_server_;
    dynamic_reconfigure::Server<v9_ball_pillar_detector::BallDetectorParamsConfig>::CallbackType param_cb_;
    void paramCallback(v9_ball_pillar_detector::BallDetectorParamsConfig &_config, uint32_t level);
    ...
    static const float MIN_CONTOUR_AREA_PILLAR;
    ...
    cv::Mat segmentColor(cv::Mat &_segmented_green, cv::Mat &_inv_segmented_green,
