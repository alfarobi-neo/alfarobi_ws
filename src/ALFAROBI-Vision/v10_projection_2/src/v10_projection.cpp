...
Projection::Projection():nh_(ros::this_node::getName()),it_(nh_),
    ...
    isg_sub_(nh_,"/v10_goalpost_detector_node/inv_segment_green",1),
    fb_sub_(nh_,"/v10_goalpost_detector_node/field_boundary",1),
    ...
    // pillar_pos_sub_(nh_.subscribe("/v10_pillar_detector_node/pillar_pos",1,&Projection::pillarPosCb,this)),
