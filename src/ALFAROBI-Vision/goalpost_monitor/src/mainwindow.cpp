#include "goalpost_monitor/mainwindow.h"
...
MainWindow::MainWindow(QWidget *parent) :
    ...
    icon_path << ros::package::getPath("goalpost_monitor") << "/icon/logo_alfarobi.png";
    QIcon icon_file;
    icon_file.addFile(icon_path.str().c_str());
    this->setWindowIcon(icon_file);

    std::stringstream style_path;
    style_path << ros::package::getPath("goalpost_monitor") << "/style/vision_style.qss";
...
void MainWindow::browseLUT(){
    QString LUT_path = QFileDialog::getOpenFileName(this,"Search LUT file...",ros::package::getPath("v10_goalpost_detector").c_str(),"XML File(*.xml)");
...
void MainWindow::updateParam1Value(int _value){
    ...
    ros::service::call("/v10_goalpost_detector_node/set_parameters",srv_req_,srv_resp_);
