...
#include "v10_projection/v10_amcl.h"
...
private:
    ...
    v10_projection::LocalizationParamsConfig new_params_;
    bool params_req_;
...
//#endif
    ...
    //////////////
    ros::Subscriber hline_pos_sub_;
    geometry_msgs::Point hline_pos_;
    void hlinePosCb(const geometry_msgs::PointConstPtr &_msg){
        hline_pos_.x = _msg->x;
        hline_pos_.y = _msg->y;
        hline_pos_.z = _msg->z;
    }

    ros::Publisher projected_hline_pub_;
    ros::Publisher projected_hline_stamped_pub_;
    ///////////////
    ...
    void publishData();
        ...
        dynamic_reconfigure::Server<v10_projection::LocalizationParamsConfig >::CallbackType param_cb_;
        dynamic_reconfigure::Server<v10_projection::LocalizationParamsConfig > server_;
        void paramCallback(v10_projection::LocalizationParamsConfig &_config, uint32_t level);
    ...
    void loadParams(){
        ...
        try{
            ...
            ROS_ERROR("[v10_projection] Unable to load offset file: %s", e.what());
        }
