...
#include <v12_goalpost_white_detector/GoalpostDetectorParamsConfig.h>
...
private:
    ...
    v12_goalpost_white_detector::GoalpostDetectorParamsConfig config_;
    dynamic_reconfigure::Server<v12_goalpost_white_detector::GoalpostDetectorParamsConfig> param_server_;
    dynamic_reconfigure::Server<v12_goalpost_white_detector::GoalpostDetectorParamsConfig>::CallbackType param_cb_;
    void paramCallback(v12_goalpost_white_detector::GoalpostDetectorParamsConfig &_config, uint32_t level);
