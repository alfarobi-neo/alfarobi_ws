...
#include "cat2_monitor/frameviewer.h"
...
private:
    ...
    QLabel *ratio1_label_;
    QSlider *ratio1_slider_;
    QLabel *ratio2_label_;
    QSlider *ratio2_slider_; 
...
private slots:
    ...
    void browseLUT();
    void saveParam();
    void getSquareReference(QImage _img);
