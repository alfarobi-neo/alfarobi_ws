...
const double Kinematics::HIP_OFFSET_X = 0.0175;
const double Kinematics::LEG_SIDE_OFFSET = 0.046;//0.038525; //0.038;//m //50; //37.0; //mm
const double Kinematics::HIP_OFFSET_Z = 0.09728;//0.077;//0.096;//m
...
const double Kinematics::BODY_LENGTH = 0.255;
