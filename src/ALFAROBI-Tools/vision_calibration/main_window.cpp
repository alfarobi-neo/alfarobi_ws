...
{
  ui->setupUi(this);
  this->setWindowTitle("Vision Calibration");
...
{
  QString filepath = QFileDialog::getOpenFileName(this, tr("Open File"), "/home/haritsahm/", "All Files (*.*)");
...
{
  QString filepath = QFileDialog::getOpenFileName(this, tr("Open File"), "/home/haritsahm/", "XML File (*.xml)");
