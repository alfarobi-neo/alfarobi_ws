...
private:
    ...
    void loadParams(){
        num_particles_sb_->setValue(0);
        range_var_dsb_->setValue(0.3);
        beam_var_dsb_->setValue(1.047);
        alpha1_lined_->setText(0);
        alpha2_lined_->setText(0);
        alpha3_lined_->setText(0);
        alpha4_lined_->setText(0);
    }
private slots:
