...
RobotInfo = "robot_info" / Struct(
    # define NONE                        0
    # define PENALTY_HL_KID_BALL_MANIPULATION    30
    # define PENALTY_HL_KID_PHYSICAL_CONTACT     31
    # define PENALTY_HL_KID_ILLEGAL_ATTACK       
    # define PENALTY_HL_KID_ILLEGAL_DEFENSE      4
    # define PENALTY_HL_KID_REQUEST_FOR_PICKUP   34
    # define PENALTY_HL_KID_REQUEST_FOR_SERVICE  35
...
TeamColor = { 'BLUE':0, 'RED':1, 'YELLOW':2, 'BLACK':3, 'WHITE':4, 'GREEN':5, 'ORANGE':6, 'PURPLE':7, 'BROWN':8, 'GRAY':9}
States = {  'STATE_INITIAL':0, 'STATE_READY':1, 'STATE_SET':2, 'STATE_PLAYING':3, 'STATE_FINISHED':4}
Secondary = { 'STATE_NORMAL':0, 'STATE_PENALTYSHOOT':1, 'STATE_OVERTIME':2, 'STATE_TIMEOUT':3, 
                'STATE_DIRECT_FREEKICK':4, 'STATE_INDIRECT_FREEKICK':5, 'STATE_PENALTYKICK':6, 'DROPBALL':128, 'UNKNOWN':255 }
