...
"""autogenerated by genpy from humanoid_league_msgs/ObstaclesInImage.msg. Do not edit."""
import codecs
import sys
...
class ObstaclesInImage(genpy.Message):
  _md5sum = "0807f4239b3cd59edd38069d2f956035"
  _type = "humanoid_league_msgs/ObstaclesInImage"
...
"""
  ...
  _slot_types = ['std_msgs/Header','humanoid_league_msgs/ObstacleInImage[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObstaclesInImage, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.obstacles:
        ...
        _x = val1
        buff.write(_get_struct_2Bf().pack(_x.height, _x.width, _x.confidence))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = humanoid_league_msgs.msg.ObstacleInImage()
        _x = val1
        start = end
        end += 2
        ...
        (_x.height, _x.width, _x.confidence,) = _get_struct_2Bf().unpack(str[start:end])
