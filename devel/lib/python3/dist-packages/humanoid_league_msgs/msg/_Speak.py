...
"""autogenerated by genpy from humanoid_league_msgs/Speak.msg. Do not edit."""
import codecs
import sys
...
class Speak(genpy.Message):
  _md5sum = "f360f3d1d1c01a5c835f4716354e4c26"
  _type = "humanoid_league_msgs/Speak"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# This message is used to activate the audio output of the robot
...
string filename"""
  ...
  __slots__ = ['text','priority','filename']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Speak, self).__init__(*args, **kwds)
