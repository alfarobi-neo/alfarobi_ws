...
"""autogenerated by genpy from humanoid_league_msgs/GameState.msg. Do not edit."""
import codecs
import sys
...
class GameState(genpy.Message):
  _md5sum = "36ea982046fabfdd283bc1d352aa9438"
  _type = "humanoid_league_msgs/GameState"
...
"""
  ...
  __slots__ = ['header','gameState','secondaryState','secondrayStateTeam','firstHalf','ownScore','rivalScore','secondsRemaining','secondary_seconds_remaining','hasKickOff','penalized','secondsTillUnpenalized','allowedToMove','dropInTeam','dropInTime','penaltyShot','singleShots','coach_message']
  _slot_types = ['std_msgs/Header','uint8','uint8','uint8','bool','uint8','uint8','int16','uint16','bool','bool','uint16','bool','bool','uint16','uint8','uint16','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,gameState,secondaryState,secondrayStateTeam,firstHalf,ownScore,rivalScore,secondsRemaining,secondary_seconds_remaining,hasKickOff,penalized,secondsTillUnpenalized,allowedToMove,dropInTeam,dropInTime,penaltyShot,singleShots,coach_message
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6BhH2BH2BHBH().pack(_x.gameState, _x.secondaryState, _x.secondrayStateTeam, _x.firstHalf, _x.ownScore, _x.rivalScore, _x.secondsRemaining, _x.secondary_seconds_remaining, _x.hasKickOff, _x.penalized, _x.secondsTillUnpenalized, _x.allowedToMove, _x.dropInTeam, _x.dropInTime, _x.penaltyShot, _x.singleShots))
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_6BhH2BH2BHBH = None
def _get_struct_6BhH2BH2BHBH():
    global _struct_6BhH2BH2BHBH
    if _struct_6BhH2BH2BHBH is None:
        _struct_6BhH2BH2BHBH = struct.Struct("<6BhH2BH2BHBH")
    return _struct_6BhH2BH2BHBH
