...
let ObstacleRelative = require('./ObstacleRelative.js');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ObstaclesRelative {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.obstacles.forEach((val) => {
      bufferOffset = ObstacleRelative.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ObstaclesRelative(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.obstacles[i] = ObstacleRelative.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 38 * object.obstacles.length;
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ObstaclesRelative(null);
    ...
    if (msg.obstacles !== undefined) {
      ...
      for (let i = 0; i < resolved.obstacles.length; ++i) {
        resolved.obstacles[i] = ObstacleRelative.Resolve(msg.obstacles[i]);
      }
    }
    else {
      resolved.obstacles = []
...
module.exports = ObstaclesRelative;
