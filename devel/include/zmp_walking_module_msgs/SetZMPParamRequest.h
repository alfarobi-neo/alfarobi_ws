...
bool operator==(const ::zmp_walking_module_msgs::SetZMPParamRequest_<ContainerAllocator1> & lhs, const ::zmp_walking_module_msgs::SetZMPParamRequest_<ContainerAllocator2> & rhs)
{
