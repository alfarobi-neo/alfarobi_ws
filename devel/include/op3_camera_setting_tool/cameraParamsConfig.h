...
namespace op3_camera_setting_tool
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(cameraParamsConfig &config, const cameraParamsConfig &max, const cameraParamsConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const cameraParamsConfig &config1, const cameraParamsConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, cameraParamsConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const cameraParamsConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, cameraParamsConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const cameraParamsConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const cameraParamsConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, cameraParamsConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 16 "/home/fariz/Desktop/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg"
      const int cameraParams_auto = 0;
//#line 17 "/home/fariz/Desktop/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg"
      const int cameraParams_manual = 1;
//#line 18 "/home/fariz/Desktop/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg"
      const int cameraParams_shutter_priority = 2;
//#line 19 "/home/fariz/Desktop/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg"
