...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(cameraParamsConfig::AbstractParamDescriptionConstPtr(new cameraParamsConfig::ParamDescription<int>("exposure_auto", "int", 0, "Auto Exposure", "{'enum': [{'name': 'auto', 'type': 'int', 'value': 0, 'srcline': 16, 'srcfile': '/home/ajus/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg', 'description': 'Exposure Auto', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'manual', 'type': 'int', 'value': 1, 'srcline': 17, 'srcfile': '/home/ajus/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg', 'description': 'Exposure Manual', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'shutter_priority', 'type': 'int', 'value': 2, 'srcline': 18, 'srcfile': '/home/ajus/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg', 'description': 'Exposure : Shutter priority', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'aperture_priority', 'type': 'int', 'value': 3, 'srcline': 19, 'srcfile': '/home/ajus/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg', 'description': 'Exposure : Aperture priority', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &cameraParamsConfig::exposure_auto)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 16 "/home/ajus/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg"
      const int cameraParams_auto = 0;
//#line 17 "/home/ajus/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg"
      const int cameraParams_manual = 1;
//#line 18 "/home/ajus/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg"
      const int cameraParams_shutter_priority = 2;
//#line 19 "/home/ajus/alfarobi_ws/src/ALFAROBI-Tools/op3_camera_setting_tool/cfg/camera_params.cfg"
