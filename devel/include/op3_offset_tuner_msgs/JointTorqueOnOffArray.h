...
struct JointTorqueOnOffArray_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::op3_offset_tuner_msgs::JointTorqueOnOff_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::op3_offset_tuner_msgs::JointTorqueOnOff_<ContainerAllocator> >> _torque_enable_data_type;
...
bool operator==(const ::op3_offset_tuner_msgs::JointTorqueOnOffArray_<ContainerAllocator1> & lhs, const ::op3_offset_tuner_msgs::JointTorqueOnOffArray_<ContainerAllocator2> & rhs)
{
