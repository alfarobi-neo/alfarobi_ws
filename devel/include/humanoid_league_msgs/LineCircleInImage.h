...
bool operator==(const ::humanoid_league_msgs::LineCircleInImage_<ContainerAllocator1> & lhs, const ::humanoid_league_msgs::LineCircleInImage_<ContainerAllocator2> & rhs)
{
