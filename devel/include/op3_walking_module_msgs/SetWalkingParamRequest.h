...
bool operator==(const ::op3_walking_module_msgs::SetWalkingParamRequest_<ContainerAllocator1> & lhs, const ::op3_walking_module_msgs::SetWalkingParamRequest_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::op3_walking_module_msgs::SetWalkingParamRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xdac3578eb03fe27eULL;
  static const uint64_t static_value2 = 0x15520f1bace531fbULL;
};
