...
public:
    ...
    {
        MainWindowDesign->setWindowTitle(QApplication::translate("MainWindowDesign", "ROBOTIS-OP3 Tuner Client", Q_NULLPTR));
        ...
        clear_button->setText(QApplication::translate("MainWindowDesign", "Clear", Q_NULLPTR));
        ...
        save_offset_button->setText(QApplication::translate("MainWindowDesign", "Save Offset", Q_NULLPTR));
        save_gain_button->setText(QApplication::translate("MainWindowDesign", "Save Gain", Q_NULLPTR));
        tuning_pose_button->setText(QApplication::translate("MainWindowDesign", "Tuning Pose", Q_NULLPTR));
        tuning_pose_comboBox->clear();
        tuning_pose_comboBox->insertItems(0, QStringList()
         << QApplication::translate("MainWindowDesign", "tune_pose_01", Q_NULLPTR)
         << QApplication::translate("MainWindowDesign", "tune_pose_02", Q_NULLPTR)
         << QApplication::translate("MainWindowDesign", "tune_pose_03", Q_NULLPTR)
         << QApplication::translate("MainWindowDesign", "tune_pose_04", Q_NULLPTR)
        );
    } // retranslateUi
