...
#include "../../../src/ALFAROBI-Vision/localization_monitor/include/localization_monitor/dataviewer.h"
...
void DataViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DataViewer *_t = static_cast<DataViewer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateViewer(); break;
        default: ;
        }
        ...
        {
            typedef void (DataViewer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataViewer::updateViewer)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DataViewer::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_DataViewer.data,
      qt_meta_data_DataViewer,  qt_static_metacall, nullptr, nullptr}
};
