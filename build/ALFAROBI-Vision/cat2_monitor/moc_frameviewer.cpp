...
#include "../../../src/ALFAROBI-Vision/cat2_monitor/include/cat2_monitor/frameviewer.h"
...
QT_MOC_LITERAL(6, 40, 15), // "squareReference"
QT_MOC_LITERAL(7, 56, 11), // "updateFrame"
QT_MOC_LITERAL(8, 68, 16), // "colorClassAccept"
QT_MOC_LITERAL(9, 85, 16) // "colorClassReject"

    },
    "FrameViewer\0getROI\0\0_img\0colorClass\0"
    "idx\0squareReference\0updateFrame\0"
...
void FrameViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->squareReference((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        ...
        {
            typedef void (FrameViewer::*_t)(const QImage & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FrameViewer::squareReference)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void FrameViewer::squareReference(const QImage & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
