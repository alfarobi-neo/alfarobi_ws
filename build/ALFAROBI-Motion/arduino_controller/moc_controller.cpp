...
#include "../../../src/ALFAROBI-Motion/arduino_controller/controller.h"
...
QT_MOC_LITERAL(4, 27, 3) // "run"
    ...
    "Controller\0finished\0\0start\0run"
};
...
void Controller::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Controller::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Controller::start)) {
                *result = 1;
                return;
            }
        }
