...
set(MSG_I_FLAGS "-Igame_controller:/home/alfarobi/alfarobi_ws/src/ALFAROBI-Communication/game_controller/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/alfarobi/alfarobi_ws/src/ALFAROBI-Communication/game_controller/msg/GameState.msg" NAME_WE)
add_custom_target(_game_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "game_controller" "/home/alfarobi/alfarobi_ws/src/ALFAROBI-Communication/game_controller/msg/GameState.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(game_controller
  "/home/alfarobi/alfarobi_ws/src/ALFAROBI-Communication/game_controller/msg/GameState.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/game_controller)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/game_controller\")")
  # install generated code
  install(
