...
set(MSG_I_FLAGS "-Igame_controller:/home/ajus/alfarobi_ws/src/ALFAROBI-Communication/game_controller/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ajus/alfarobi_ws/src/ALFAROBI-Communication/game_controller/msg/GameState.msg" NAME_WE)
add_custom_target(_game_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "game_controller" "/home/ajus/alfarobi_ws/src/ALFAROBI-Communication/game_controller/msg/GameState.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(game_controller
  "/home/ajus/alfarobi_ws/src/ALFAROBI-Communication/game_controller/msg/GameState.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/game_controller)
  install(CODE "execute_process(COMMAND \"/home/ajus/anaconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/game_controller\")")
  # install generated code
  install(
